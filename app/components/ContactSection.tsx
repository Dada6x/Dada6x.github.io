				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<motion.a
								href="mailto:abdalrazaq@gmail.com"
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@ABDALRAZAQ</p>
									</div>
								</motion.a>
								<motion.a
									href="#"
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">Abd al Razaq</p>
									</div>
								</motion.a>
								<motion.a
									href="#"
								...
								>
									...
									<div>
										<p className="font-semibold text-gray-200">CodeForces</p>
										<p className="text-sm text-gray-400">@ABDALRazaq</p>
									</div>
								</motion.a>
							</div>
