			...
			<div className="relative z-10 max-w-4xl w-full mx-4">
				...
				>
					...
					<div className="font-mono">
						<p className="text-green-500">$ who_am_	i</p>
						<h1 className="text-4xl md:text-5xl font-bold mt-2 mb-4">Abd Alrazaq</h1>
						<p className="text-gray-400 mb-2">Senior Backend Engineer</p>
						<p className="text-green-500">$ skills</p>
						<div className="flex flex-wrap gap-2 mt-2">
							<span className="px-3 py-1 bg-green-500/10 rounded-md border border-green-500/20">.Net</span>
							<span className="px-3 py-1 bg-green-500/10 rounded-md border border-green-500/20">Laravel</span>
							<span className="px-3 py-1 bg-green-500/10 rounded-md border border-green-500/20">Three.js</span>
