...
export const metadata: Metadata = {
	title: 'Abd Alrazaq - Backend Developer',
	description:
	...
	authors: [{ name: 'Abd Alrazaq' }],
	creator: 'Abd Alrazaq',
	openGraph: {
		title: 'Abd Alrazaq - Backend Developer Portfolio',
		...
		siteName: 'Abd Alrazaq - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Abd Alrazaq - Backend Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
